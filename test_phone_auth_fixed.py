...
class PhoneAuthTester:
    ...
    def test_phone_based_authentication_system(self):
        ...
        # Use unique phone number with timestamp to avoid conflicts
        timestamp = str(int(time.time()))[-6:]  # Last 6 digits of timestamp
        
        # Test data as specified in the review request (with unique phone number)
        test_client_data = {
            "phone_number": f"123456{timestamp}",  # Make it unique
            "first_name": "Test",
            "last_name": "Client", 
            "password": "testpassword123",
            "email": f"test{timestamp}@example.com"  # Optional but unique
        }
        ...
        # Step 4: Test Admin Client Creation (with delay to avoid database lock)
        print("\n🔍 Step 4: Testing admin client creation...")
        
        admin_created_client_data = {
            "phone_number": f"987654{timestamp}",  # Unique phone number
            "first_name": "Admin",
            "last_name": "Created",
            "password": "admincreated123",
            "email": f"admincreated{timestamp}@example.com"  # Unique email
        }
        ...
        if admin_token:
            ...
            # Add a small delay to avoid database lock
            time.sleep(2)
        ...
        short_password_data = {
            "phone_number": f"555555{timestamp}",
            "first_name": "Short",
            "last_name": "Password",
        ...
        if success:
            ...
            print(f"      Error: Password validation working correctly")
        else:
...
def main():
    print("🚀 Phone-Based Authentication System Tests (Fixed)")
